	...
	<div class="container">
      	   ...
      	   <div class="account_grid">
			   <div class=" login-right">
				...
				<form  action="admin_update_pass.php" name="updatepass" id="updatepass" method="POST">
					
					
				  <div>
					<span >OLD PASSWORD<label style="color:red;">*</label></span>
					<input type="password"  placeholder="Enter password" class="input input1 form-control" name="oldpassword" id="oldpassword"onblur="checkoldpassword()" required>
				  </div>
